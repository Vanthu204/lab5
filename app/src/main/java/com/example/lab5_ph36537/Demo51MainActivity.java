...
import com.example.lab5_ph36537.delete.InterfaceDelete;
import com.example.lab5_ph36537.select.InterfaceSelect;
import com.example.lab5_ph36537.select.SvrResponseSelect;
import com.example.lab5_ph36537.update.InterfaceUpdate;
...
public class Demo51MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn4=findViewById(R.id.btnupdate);
    ...
    private void insertData(EditText txt1, EditText txt2, EditText txt3, TextView tvKQ){
        ...
        Retrofit retrofit=new Retrofit.Builder()
                .baseUrl("http://192.168.0.102/000/")
